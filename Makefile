...
test : build test-dep-1 test-dep-2 test-dep-3 test-dep-4 test-dep-5 test-autoloads test-travis
	@cd $(TEST_DIR)                                   && \
...
test-interactive : build test-dep-1 test-dep-2 test-dep-3 test-dep-4 test-dep-5 test-autoloads test-travis
	@cd $(TEST_DIR)                                               && \
	(for test_lib in *-test.el; do                                   \
